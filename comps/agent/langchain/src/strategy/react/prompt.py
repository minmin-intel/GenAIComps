...
You must always end your output in JSON format.
...
REACT_AGENT_LLAMA_PROMPT_V3 ="""\
Given the user request, think through the problem step by step and solve the problem step by step.
Observe the outputs from the tools in the execution history, and use your reasoning to decide if you can come up with an answer or not.
When you cannot get the answer at first, do not give up. Reflect on the steps you have taken so far and try to solve the problem in a different way.
...
You MUST ALWAYS either make tool calls or provide an answer in JSON format in a new line.

User request: {input}
Now begin!
"""

REACT_AGENT_LLAMA_PROMPT_V4 ="""\
Given the user request, think through the problem and solve the problem step by step.
