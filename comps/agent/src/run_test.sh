...
output=$WORKDIR/datasets/financebench/results/finqa_agent_v6_all_t0p5.json
...
python test.py \
    ...
    --timeout 600 \
    --output $output | tee $WORKDIR/datasets/financebench/results/finqa_agent_v6_all_t0p5.log
